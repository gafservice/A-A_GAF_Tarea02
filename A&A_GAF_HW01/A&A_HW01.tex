...
\title{Tarea 1: Gradientes, Matrices positivas definidas, Ecuaciones normales}
...
%------------------------------------------------------------------------------%
Al resolver el conjunto de preguntas que se presentan en esta tarea por medio de las propiedades de gradientes y trazas vistas en clase, se busca familiarizarse con dicho conceptos, siendo estos la base para un mejor entendimiento de los procesos que conllevan el Aprendizaje Automático
